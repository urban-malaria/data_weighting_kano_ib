...
dry_season_kano_data_without_rdt <- read_dta(file.path(dhsDir,"nigeria/kano_ibadan_epi/new_field_data/Kano Dry Season Data_latest_Nov2024/Kano dry season survey data/Dry Season Data inclusive of wrong coordiates.dta"))[, -c(2,3)]

dry_season_kano_data_rdt <- read_dta(file.path(dhsDir,"nigeria/kano_ibadan_epi/new_field_data/Kano Dry Season Data_latest_Nov2024/Kano dry season survey data/KN dry hhold with RDT_131124.dta"))
...
write_csv(modified_merged_dataset_mod, file.path(dhsDir,"nigeria/kano_ibadan_epi/new_field_data/kano_malaria_weighted_information_final_dry_season_new.csv"))
