...
Maldir <- file.path(dhsDir,"nigeria/kano_ibadan_epi/new_field_data/last_upload_Akinyemi/Kano Dry Household questionnaire/")
...
names(widedata_hh) <- sapply(names(widedata_hh), stata_format)
...
wide_data_together <- left_join(widedata_hh) %>% 
