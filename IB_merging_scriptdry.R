...
Maldir <- file.path("/Users/macbookpro",dhsDir,"nigeria/kano_ibadan_epi/new_field_data/Ibadan Dry Season data_latest_Nov24/Ibadan Dry season survey data")
IbDir <- file.path("/Users/macbookpro",dhsDir,"nigeria/kano_ibadan_epi/new_field_data/Ibadan Dry Season Corrected Household Data_Jan 2025")  
...
wide_data_together <- wide_ib_data %>% 
  ...
  left_join(ib_women_mob_survey, by = ("sn")) %>% 
